...
class Format():
    def __init__(self, fmt):
        ...
        if fmt in ("0", "1", "2", "3", "4", "5"):
            ...
            self.add("Y", "c_long", 1)
            self.add("Z", "c_long", 1)
            self.add("intensity",  "c_ushort", 1)
            self.add("flag_byte", "c_ubyte", 1)
            self.add("raw_classification", "c_ubyte", 1)
            self.add("scan_angle_rank", "c_ubyte", 1)
            self.add("user_data",  "c_ubyte", 1)
            self.add("pt_src_id",  "c_ushort", 1)
        if fmt in ("1", "3", "4", "5"):
            self.add("gps_time", "c_double", 1)
        if fmt in ("3", "5"):
            self.add("red", "c_ushort", 1)
            self.add("green", "c_ushort", 1)
            self.add("blue" , "c_ushort",1)
        elif fmt == "2":
            self.add("red", "c_ushort", 1)
            self.add("green", "c_ushort", 1)
            self.add("blue" , "c_ushort",1)
        if fmt == "4":
            self.add("wave_packet_descp_idx", "c_ubyte", 1)
            self.add("byte_offset_to_wavefm_data", "c_ulonglong",1)
            self.add("wavefm_pkt_size","c_long", 1)
            self.add("return_pt_wavefm_loc",  "c_float", 1)
            self.add("x_t", "c_float", 1)
            self.add("y_t", "c_float", 1)           
            self.add("z_t", "c_float", 1)
        elif fmt == "5":
            self.add("wave_packet_descp_idx", "c_ubyte", 1)
            self.add("byte_offset_to_wavefm_data", "c_ulonglong",1)
            self.add("wavefm_pkt_size", "c_long", 1)
        ...
        ## VLR Fields
        if fmt == "VLR":
            self.add("reserved", "c_ushort", 1)
            self.add("user_id", "c_char", 16)
            self.add("record_id", "c_ushort", 1)
            self.add("rec_len_after_header", "c_ushort", 1)
            self.add("descriptions", "c_char", 32, compress = True)
        
        ## Header Fields
        if fmt[0] == "h":
            self.add("file_sig","c_char", 4, compress = True)
            self.add("file_src", "c_ushort", 1)
            self.add("global_encoding","c_ushort", 1)
            self.add("proj_id_1","c_long", 1)
            self.add("proj_id_2", "c_ushort", 1)
            self.add("proj_id_3", "c_ushort", 1)
            self.add("proj_id_4", "c_ubyte", 8)
            self.add("version_major", "c_ubyte", 1)
            self.add("version_minor", "c_ubyte", 1)
            self.add("sys_id", "c_char", 32, compress=True)
            self.add("gen_soft",  "c_char", 32, compress = True)
            self.add("created_day", "c_ushort", 1)
            self.add("created_year", "c_ushort",1)
            self.add("header_size", "c_ushort", 1)
            self.add("offset_to_point_data", "c_long", 1)
            self.add("num_variable_len_recs",  "c_long", 1)
            self.add("pt_dat_format_id",  "c_ubyte", 1)
            self.add("pt_dat_rec_len",  "c_ushort", 1)
            self.add("num_pt_recs", "c_long", 1)         
            if fmt == "h1.3":
                self.add("num_pts_by_return",  "c_long", 7)
                self.add("x_scale", "c_double", 1)
                self.add("y_scale", "c_double", 1)
                self.add("z_scale", "c_double", 1)
                self.add("x_offset", "c_double", 1)
                self.add("y_offset", "c_double", 1)
                self.add("z_offset", "c_double", 1) 
                self.add("x_max", "c_double", 1)
                self.add("x_min", "c_double", 1)
                self.add("y_max","c_double", 1)
                self.add("y_min","c_double", 1)
                self.add("z_max", "c_double", 1)
                self.add("z_min", "c_double", 1)
            elif fmt in ("h1.0", "h1.1", "h1.2"):
                self.add("num_pts_by_return", "c_long", 5)
                self.add("x_scale", "c_double", 1)
                self.add("y_scale", "c_double", 1)
                self.add("z_scale", "c_double", 1)
                self.add("x_offset", "c_double", 1)
